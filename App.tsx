    ...
    return (
     <GoogleOAuthProvider clientId={import.meta.env.VITE_GOOGLE_CLIENT_ID || "YOUR_GOOGLE_CLIENT_ID"}>
      <div className="min-h-screen bg-brand-50 flex items-center justify-center p-4 relative overflow-hidden">
        <a href="https://prisma.bibliohispa.es/" className="absolute top-4 left-4 z-50 p-2 bg-white/80 hover:bg-white rounded-full shadow-sm text-slate-500 hover:text-brand-600 transition-all flex items-center gap-2 text-sm font-bold backdrop-blur-sm">
            <ArrowLeft size={20} /> <span className="hidden sm:inline">Volver a Prisma</span>
        </a>
