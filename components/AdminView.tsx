    ...
    <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-6">
      <header className="flex flex-col md:flex-row justify-between items-center gap-4 bg-white p-6 rounded-3xl shadow-sm border border-slate-100 no-print">
        <div className="flex items-center gap-4">
          <a href="https://prisma.bibliohispa.es/" className="mr-2 p-2 bg-slate-50 hover:bg-brand-50 text-slate-400 hover:text-brand-600 rounded-xl transition-all border border-slate-100" title="Volver a Prisma">
             <ArrowLeft size={24} />
          </a>
